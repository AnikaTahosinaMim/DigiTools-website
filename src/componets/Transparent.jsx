    ...
    <div>
      <div>
        ...
        <div className="flex-row md:flex justify-center items-center gap-6">
          <div className="bg-zinc-100 rounded-lg border border-zinc-300 shadow-lg py-4 text-left px-10 space-y-3">
          ...
          <div className="bg-gradient-to-r from-[#4F39F6] relative  to-[#9514FA] text-white rounded-lg border border-zinc-300 shadow-lg py-4 text-left px-10 space-y-3">
